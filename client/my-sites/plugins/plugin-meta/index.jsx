...
import { isCompatiblePlugin } from 'wp-calypso-client/my-sites/plugins/plugin-compatibility';
import PluginInstallButton from 'wp-calypso-client/my-sites/plugins/plugin-install-button';
import PluginRemoveButton from 'wp-calypso-client/my-sites/plugins/plugin-remove-button';
import PluginInformation from 'wp-calypso-client/my-sites/plugins/plugin-information';
import WpcomPluginInstallButton from 'wp-calypso-client/my-sites/plugins/plugin-install-button-wpcom';
import PluginAutomatedTransfer from 'wp-calypso-client/my-sites/plugins/plugin-automated-transfer';
import { getExtensionSettingsPath } from 'wp-calypso-client/my-sites/plugins/utils';
import { userCan } from 'wp-calypso-client/lib/site/utils';
import UpsellNudge from 'wp-calypso-client/blocks/upsell-nudge';
import { FEATURE_UPLOAD_PLUGINS, TYPE_BUSINESS } from 'wp-calypso-client/lib/plans/constants';
import { findFirstSimilarPlanKey } from 'wp-calypso-client/lib/plans';
import { isBusiness, isEcommerce, isEnterprise } from 'wp-calypso-client/lib/products-values';
...
import { isAutomatedTransferActive } from 'wp-calypso-client/state/automated-transfer/selectors';
