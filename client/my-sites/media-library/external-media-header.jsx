...
import { addExternalMedia, fetchNextMediaPage } from 'wp-calypso-client/state/media/thunks';
import { changeMediaSource } from 'wp-calypso-client/state/media/actions';
