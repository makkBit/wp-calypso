...
import SubMasterbarNav from 'wp-calypso-client/components/sub-masterbar-nav';
import PageViewTracker from 'wp-calypso-client/lib/analytics/page-view-tracker';
import { addTracking, trackClick } from './helpers';
import DocumentHead from 'wp-calypso-client/components/data/document-head';
import { buildRelativeSearchUrl } from 'wp-calypso-client/lib/build-url';
...
import { openThemesShowcase } from 'wp-calypso-client/state/themes/themes-ui/actions';
import {
	getThemesBookmark,
	hasShowcaseOpened as hasShowcaseOpenedSelector,
} from 'wp-calypso-client/state/themes/themes-ui/selectors';
import ThemesSearchCard from './themes-magic-search-card';
import QueryThemeFilters from 'wp-calypso-client/components/data/query-theme-filters';
import {
	getActiveTheme,
	getThemeFilterTerms,
...
import UpworkBanner from 'wp-calypso-client/blocks/upwork-banner';
