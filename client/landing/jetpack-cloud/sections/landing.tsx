...
import isSiteAtomic from 'wp-calypso-client/state/selectors/is-site-wpcom-atomic';
import isJetpackSiteMultiSite from 'wp-calypso-client/state/sites/selectors/is-jetpack-site-multi-site';
