...
jest.mock( 'blocks/signup-form', () => require( 'wp-calypso-client/components/empty-component' ) );
jest.mock( 'lib/abtest', () => ( {
	abtest: () => '',
	getABTestVariation: () => null,
} ) );
jest.mock( 'signup/step-wrapper', () => require( 'wp-calypso-client/components/empty-component' ) );
