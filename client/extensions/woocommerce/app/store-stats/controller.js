...
import StatsPagePlaceholder from 'wp-calypso-client/my-sites/stats/stats-page-placeholder';
	...
	switch ( props.type ) {
		case 'orders':
			asyncComponent = (
				<AsyncLoad
					...
					require="wp-calypso-client/extensions/woocommerce/app/store-stats"
					{ ...props }
				/>
			);
			break;
		case 'referrers': {
			...
			asyncComponent = (
				<AsyncLoad
					placeholder={ placeholder }
					require="wp-calypso-client/extensions/woocommerce/app/store-stats/referrers"
					query={ referrerQuery }
					{ ...props }
				/>
			);
		...
		default:
			asyncComponent = (
				<AsyncLoad
					placeholder={ placeholder }
					require="wp-calypso-client/extensions/woocommerce/app/store-stats/listview"
					{ ...props }
				/>
			);
			break;
