...
import { wasManualRenewalImmediateLoginAttempted } from 'wp-calypso-client/state/immediate-login/selectors';
...
import { isPasswordlessAccount } from 'wp-calypso-client/state/login/utils';
import {
...
import VisitSite from 'wp-calypso-client/blocks/visit-site';
...
import { isWebAuthnSupported } from 'wp-calypso-client/lib/webauthn';
import JetpackPlusWpComLogo from 'wp-calypso-client/components/jetpack-plus-wpcom-logo';
...
class Login extends Component {
		...
		if ( twoStepNonce ) {
			...
			preHeader = (
				<div className="login__jetpack-logo">
					<AsyncLoad
						require="wp-calypso-client/components/jetpack-header"
						placeholder={ null }
	...
	renderContent() {
		...
		if ( socialConnect ) {
			return (
				<AsyncLoad
					require="wp-calypso-client/blocks/login/social-connect-prompt"
		...
		if ( twoFactorEnabled ) {
			return (
				<AsyncLoad
					require="wp-calypso-client/blocks/login/two-factor-authentication/two-factor-content"
