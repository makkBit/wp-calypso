...
export const createList = ( context, next ) => {
	...
	context.primary = (
		<AsyncLoad require="wp-calypso-client/reader/list-manage" key="list-manage" isCreateForm />
	);
	next();
};
...
export const listListing = ( context, next ) => {
	...
	context.primary = (
		<AsyncLoad
			require="wp-calypso-client/reader/list-stream"
...
export const editList = ( context, next ) => {
	...
	context.primary = (
		<AsyncLoad
			require="wp-calypso-client/reader/list-manage"
			key="list-manage"
			owner={ encodeURIComponent( context.params.user ) }
			slug={ encodeURIComponent( context.params.list ) }
