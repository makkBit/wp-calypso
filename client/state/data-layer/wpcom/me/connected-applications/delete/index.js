 ...
 */
import { CONNECTED_APPLICATION_DELETE } from 'wp-calypso-client/state/action-types';
import { deleteConnectedApplicationSuccess } from 'wp-calypso-client/state/connected-applications/actions';
