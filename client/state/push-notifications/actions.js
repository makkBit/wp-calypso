...
import { registerServerWorker } from 'wp-calypso-client/lib/service-worker';
import { recordTracksEvent, bumpStat } from 'wp-calypso-client/state/analytics/actions';

import 'wp-calypso-client/state/push-notifications/init';
...
export function init() {
	return ( dispatch ) => {
		...
		const { isSupportSession } = require( 'wp-calypso-client/lib/user/support-user-interop' );
		if ( isSupportSession() ) {
