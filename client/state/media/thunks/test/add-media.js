 ...
 */
import { addMedia as addMediaThunk } from 'wp-calypso-client/state/media/thunks/add-media';
import { uploadMedia } from 'wp-calypso-client/state/media/thunks/upload-media';
import { getFileUploader } from 'wp-calypso-client/lib/media/utils';
