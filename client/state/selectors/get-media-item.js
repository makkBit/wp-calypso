...
import getMediaItemServerIdFromTransientId from 'wp-calypso-client/state/selectors/get-media-item-server-id-from-transient-id';
import getMediaQueryManager from 'wp-calypso-client/state/selectors/get-media-query-manager';
