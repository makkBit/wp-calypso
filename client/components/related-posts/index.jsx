 ...
 */
import { relatedPostsForPost } from 'wp-calypso-client/state/reader/related-posts/selectors';
import { SCOPE_SAME, SCOPE_OTHER } from 'wp-calypso-client/state/reader/related-posts/utils';
import RelatedPost from 'wp-calypso-client/blocks/reader-related-card';
import QueryReaderRelatedPosts from 'wp-calypso-client/components/data/query-reader-related-posts';
