		...
		switch ( partnerSlug ) {
			case 'dreamhost':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/dreamhost"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
			...
			case 'pressable':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/pressable"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
			...
			case 'bluehost':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/bluehost"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
			...
			case 'inmotion':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/inmotion"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
			...
			case 'milesweb':
				...
				return (
					<AsyncLoad
						require="wp-calypso-client/components/jetpack-header/milesweb"
						darkColorScheme={ darkColorScheme }
						placeholder={ null }
					/>
				);
			...
			case 'liquidweb':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/liquidweb"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
			...
			case 'eurodns':
				return (
					...
					>
						<AsyncLoad
							require="wp-calypso-client/components/jetpack-header/eurodns"
							darkColorScheme={ darkColorScheme }
							placeholder={ null }
						/>
					</JetpackPartnerLogoGroup>
