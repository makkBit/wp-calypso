 ...
 */
import Shortcode from 'wp-calypso-client/blocks/shortcode';
import { parse as parseShortcode } from 'wp-calypso-client/lib/shortcode';
import { generateGalleryShortcode } from 'wp-calypso-client/lib/media/utils';
import { GalleryDefaultAttrs } from 'wp-calypso-client/lib/media/constants';
